...
//////////////////////////////////////////////////////////////
  var widgets = {
    ...
    dimmer_1 : function(wgt_obj) {
      ...
      ret_str += '   <button id="' + comp_div_id + '_icon" class="widget_icon mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect" onclick="slider_adjust(\'' + wgt_obj['widget_id'] + '\',\'' + comp_div_id + '\',\'toggle\');"><i class="material-icons">lightbulb_outline</i></button>\n';
      ...
      ret_str += '   <button class="f1 mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect" onclick="slider_adjust(\'' + wgt_obj['widget_id'] + '\',\'' + comp_div_id + '\',\'minus\');"><i class="material-icons">remove</i></button>\n';
      ret_str += '   <button class="f2 mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect" onclick="slider_adjust(\'' + wgt_obj['widget_id'] + '\',\'' + comp_div_id + '\',\'' + wgt_obj['fave_1'] + '\');"><span>' + wgt_obj['fave_1'] + '%</span></button>\n';
      ret_str += '   <button class="f4 mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect" onclick="slider_adjust(\'' + wgt_obj['widget_id'] + '\',\'' + comp_div_id + '\',\'plus\');"><i class="material-icons">add</i></button>\n';
      ret_str += '   <button class="f3 mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect" onclick="slider_adjust(\'' + wgt_obj['widget_id'] + '\',\'' + comp_div_id + '\',\'' + wgt_obj['fave_2'] + '\');"><span>' + wgt_obj['fave_2'] + '%</span></button>\n';
      ret_str += ' </div>\n';
